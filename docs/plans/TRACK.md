...
Last updated: 2026-08-15 (Phases 17-21: reduce default tool-response data volume, plus Phase 18 inserted to fix two confirmed list_work_items/search_work_items correctness bugs — see Decisions/deviations entry 13)
...
Plan docs: `plans/plane-mcp/00-rfc.md` (RFC) through `plans/plane-mcp/21-context-docs.md`. Phases 18-20 of the
...
paths now contain redirect stubs only.
